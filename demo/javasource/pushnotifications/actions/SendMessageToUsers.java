...
public class SendMessageToUsers extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	private java.util.List<IMendixObject> __Users;
	private java.util.List<system.proxies.User> Users;

	public SendMessageToUsers(IContext context, IMendixObject MessageData, java.util.List<IMendixObject> Users)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		this.Users = new java.util.ArrayList<system.proxies.User>();
		if (__Users != null)
			for (IMendixObject __UsersElement : __Users)
				this.Users.add(system.proxies.User.initialize(getContext(), __UsersElement));

		// BEGIN USER CODE
		List<Message> messages = createAndSendMessageToUsers(getContext(), Users, MessageData);
